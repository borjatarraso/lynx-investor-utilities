"""Metric relevance by company tier AND utility development stage.
...
For utilities sector analysis:
  CRITICAL    — Must-check metric for this stage. Highlighted with bold star marker.
                E.g. cash_runway for pre-operational developers, EV/EBITDA and
                dividend coverage for operating utilities.
...
matter most for utility companies at each development stage.
"""
...
def get_relevance(
    ...
    the development stage is the primary axis for utility analysis —
    an early-stage renewable developer uses very different KPIs than
    a mature regulated utility or a YieldCo.
    """
