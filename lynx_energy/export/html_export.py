...
""")
    ...
    if report.energy_quality:
        ...
        parts.append('<div class="card"><h2>Energy Quality Indicators</h2>')
        parts.append(_metric_table([
    ...
    if report.intrinsic_value:
        ...
        iv_fields = [
            ...
            _iv_entry("EV/Reserve Implied", iv.ev_reserve_implied_price, None),
        ]
    ...
    if c.screening_checklist:
        parts.append("<h2>Energy Screening Checklist</h2>")
    ...
    parts.append(f"""
<div class="footer">
  Lynx Energy Analysis &mdash; Lince Investor Suite<br>
