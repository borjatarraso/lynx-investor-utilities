"""Tkinter graphical user interface for Lynx Energy Analysis."""
...
class SplashScreen:
    ...
    def __init__(self, root: tk.Tk, on_done: callable) -> None:
        ...
        self.subtitle = tk.Label(
            center, text="Energy Analysis", font=FONT_SPLASH_SUB,
            bg=BG, fg=ACCENT,
        )
        ...
        self.tagline = tk.Label(
            center, text="Energy Sector Analysis", font=FONT_SMALL,
            bg=BG, fg=FG_DIM,
        )
...
class LynxEnergyGUI:
    """Tkinter GUI application for Lynx Energy Analysis."""
    ...
    def __init__(self, cli_args) -> None:
        ...
        self.root = tk.Tk()
        self.root.title("Lynx Energy Analysis")
    ...
    def _build_toolbar(self) -> None:
        ...
        tk.Label(
            brand, text="Lynx Energy", font=(_FAMILY, 14, "bold"),
    ...
    def _show_controls(self) -> None:
        ...
        self._show_info_popup(
            ...
            "lynx-energy -- Graphical Interface",
            sections,
        )
    ...
    def _ee_shake(self) -> None:
        from lynx_energy.easter import tk_fireworks
        tk_fireworks(self.root)

    def _ee_rainbow(self) -> None:
        from lynx_energy.easter import tk_rainbow_title
    ...
    def _show_sector_mismatch(self, msg: str) -> None:
        ...
        tk.Label(
            ...
            text=(
                ...
                "Utilities  |  Energy Services  |  Clean Energy"
            ),
    ...
    def _render_screening(self, r: AnalysisReport) -> None:
        """Render the energy screening checklist."""
        ...
        card = CollapsibleCard(
            self.scroll_frame, "Energy Screening Checklist",
    ...
    def _show_section_info(self, section_key: str) -> None:
        from lynx_energy.metrics.explanations import get_section_explanation
    ...
    def _show_conclusion_info(self, category: str = "overall") -> None:
        from lynx_energy.metrics.explanations import get_conclusion_explanation
...
def run_gui(args) -> None:
    ...
    app = LynxEnergyGUI(cli_args=args)
    app.run()
