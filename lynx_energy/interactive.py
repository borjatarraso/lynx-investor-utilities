"""Interactive prompt-based mode for lynx-energy."""
...
from lynx_energy.display import display_full_report, display_report_stage
...
def run_interactive():
    ...
    while True:
        ...
        if cmd in ("quit", "exit", "q"):
            ...
            if current_report:
                from lynx_energy.display import _display_energy_quality, _display_share_structure, _display_intrinsic_value, _display_market_intelligence
            ...
            if current_report and current_report.filings:
                from lynx_energy.display import _display_filings; _display_filings(current_report)
            else: console.print("[yellow]No filings available.[/]")
        elif cmd == "news":
            if current_report and current_report.news:
                from lynx_energy.display import _display_news; _display_news(current_report)
            ...
            from lynx_energy.core.storage import list_cached_tickers, get_mode
            ...
            from lynx_energy.easter import rich_matrix; rich_matrix(console)
        elif cmd == "fortune":
            from lynx_energy.easter import rich_fortune; rich_fortune(console)
        elif cmd == "rocket":
            from lynx_energy.easter import rich_rocket; rich_rocket(console)
        elif cmd == "lynx":
            from lynx_energy.easter import rich_lynx; rich_lynx(console)
        else:
